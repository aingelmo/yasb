...
IGNORED_YASB_CLASSES = ["Qt620QWindowIcon", "Qt621QWindowIcon", "Qt620QWindowToolSaveBits", "Qt621QWindowToolSaveBits"]
...
class ActiveWindowWidget(BaseWidget):
    ...
    def _on_focus_change_event(self, hwnd: int, event: WinEvent) -> None:
        ...
        if (
            ...
            or win_info["class_name"] in IGNORED_YASB_CLASSES
        ):
            return
    ...
    def _update_window_title(self, hwnd: int, win_info: dict, event: WinEvent) -> None:
        try:
            ...
            if (
                ...
                or process in self._ignore_window["processes"]
            ):
